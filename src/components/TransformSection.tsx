...
export const TransformSection = () => {
  ...
  const eventButtons = [
    ...
    {
      id: "artwall",
      titleKey: "events.youthArtWall.title",
      descKey: "events.youthArtWall.subtitle",
      fallbackTitle: "Youth Art Wall",
      fallbackDesc: "Showcase your 2D, 3D or Multimedia Artwork across all three days",
    ...
    {
      id: "yuvasrishti",
      titleKey: "events.yuvasrishti.title",
      descKey: "events.yuvasrishti.subtitle",
      fallbackTitle: "Yuvasrishti",
      fallbackDesc: "Full-day initiatives bringing innovation, fellowship, and creative projects",
