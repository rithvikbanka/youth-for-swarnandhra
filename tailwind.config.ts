    ...
    extend: {
      ...
      colors: {
        ...
        festival: {
          ...
          "red-dark": "hsl(var(--festival-red-dark))",
          ...
          gray: "hsl(var(--festival-gray))",
          offwhite: "hsl(var(--festival-offwhite))",
        },
        sidebar: {
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 20px hsla(0, 100%, 38%, 0.4)" },
          "50%": { boxShadow: "0 0 40px hsla(0, 100%, 38%, 0.6)" },
        },
      },
      animation: {
